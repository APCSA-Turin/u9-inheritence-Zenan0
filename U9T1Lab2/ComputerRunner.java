...
public class ComputerRunner {
    public static void main(String[] args) {
        ...
        for (Method m : methods) {
            ...
            if (m.getName().contains("installOperatingSystem")) {
                if (declaringClass.getName().contains("Computer")) {
            ...
            if (m.getName().contains("getScreenSize")) {
                if (declaringClass.getName().contains("Computer")) {
                    System.out.println("PASS");
                } else {
            ...
            if (m.getName().contains("getMemory")) {
                if (declaringClass.getName().contains("Computer")) {
                    System.out.println("PASS");
                } else {
